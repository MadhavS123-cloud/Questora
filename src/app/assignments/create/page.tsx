  ...
  const sectionRows = [
    {
      ...
      previewColor: 'bg-brand-100 border-brand-200 text-brand-700',
    },
    {
      label: 'Short Answer',
      icon: BookOpen,
      ...
      previewColor: 'bg-violet-100 border-violet-200 text-violet-700',
    },
    {
      label: 'Long Essay',
      icon: Layers,
      ...
      previewColor: 'bg-indigo-100 border-indigo-200 text-indigo-700',
    },
  ];

  return (
    <div className="p-6 md:p-8 space-y-6 max-w-7xl mx-auto w-full font-ui animate-fade-slide-up">

      {/* ── Header ─────────────────────────────────────────────── */}
      <div className="flex items-center gap-3 pb-2">
        <Link
          href="/"
          className="p-2 rounded-xl border border-neutral-200 hover:bg-neutral-100 text-neutral-600 hover:text-neutral-900 transition-all shadow-sm"
        >
          <ArrowLeft size={15} />
        </Link>
        <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-7 items-start">
        ...
        <div className="space-y-5">
          ...
          {/* Meta card */}
          <div className="bg-white border border-neutral-100 rounded-2xl p-6 shadow-[0_2px_16px_-4px_rgba(0,0,0,0.05)] space-y-5">
            <div className="flex items-center gap-2 pb-1 border-b border-neutral-50">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <ChevronRight size={13} className="absolute right-3 top-1/2 -translate-y-1/2 rotate-90 text-neutral-400 pointer-events-none" />
                </div>
              </div>
              <div className="space-y-1.5">
                <label className="block text-[10px] font-black text-neutral-500 uppercase tracking-widest">
          ...
          {/* Upload card */}
          <div className="bg-white border border-neutral-100 rounded-2xl p-6 shadow-[0_2px_16px_-4px_rgba(0,0,0,0.05)]">
            ...
            <div className="space-y-3">
              {sectionRows.map((row) => {
                ...
                return (
                  ...
                  >
                    <div className={clsx('w-8 h-8 rounded-lg flex items-center justify-center shrink-0', row.bg)}>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="flex flex-col gap-0.5 flex-1">
                          <span className="text-[9px] font-bold text-neutral-500 uppercase">Count</span>
                          <input
                            type="number"
                            value={row.count}
                            onChange={(e) => row.setCount(Number(e.target.value))}
                            min={0}
                            className="w-full px-2 py-1 border border-neutral-200 rounded-lg text-xs font-bold text-neutral-900 bg-white focus:outline-none focus:ring-1 focus:ring-brand-400"
                          />
                        </div>
                        <div className="flex flex-col gap-0.5 flex-1">
                          <span className="text-[9px] font-bold text-neutral-500 uppercase">Marks/Q</span>
                          <input
                            type="number"
                            value={row.marks}
                    ...
                    <div className="text-right shrink-0">
                      ...
                      <span className="block text-[9px] text-neutral-500 font-semibold uppercase">marks</span>
                    </div>
                  </div>
                );
              })}
        ...
        <div className="space-y-4 sticky top-6">
          ...
          <div className="bg-white border border-neutral-200 rounded-2xl overflow-hidden shadow-[0_4px_24px_-6px_rgba(0,0,0,0.08)]">
            {/* Header */}
            <div className="bg-gradient-to-br from-neutral-900 via-neutral-800 to-slate-900 p-5 relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-brand-600/10 via-transparent to-semantic-ai/10 pointer-events-none" />
              <span className="text-[9px] font-black uppercase tracking-widest text-brand-400 block mb-1">
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                ...
                <span className="font-bold text-slate-200">Target: {targetTotal} Marks</span>
              </p>
            </div>
              ...
              {sectionRows.map((row, si) => {
                ...
                return (
                  <div key={row.label} className="space-y-2">
                    <div className="flex items-center justify-between text-[10px] font-black text-neutral-700 uppercase tracking-wide border-b border-neutral-100 pb-1.5">
            ...
            {/* Balance bar */}
            <div className="bg-neutral-50 border-t border-neutral-100 px-5 py-4 flex items-center justify-between gap-3">
              <div>
                <p className="text-[10px] text-neutral-500 font-semibold uppercase tracking-wide">Total Allocated</p>
                <p className="text-lg font-black text-neutral-900 tabular-nums">
                  {distributedTotal} / {targetTotal}
                  <span className="text-xs font-semibold text-neutral-500 ml-1">Marks</span>
                </p>
              </div>

              {isBalanced ? (
                <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-800 text-[10px] font-extrabold uppercase tracking-wide">
                  <CheckCircle size={11} />
                  Perfectly Balanced
                </div>
              ) : (
                <div className="text-right space-y-1">
                  <div className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-amber-50 border border-amber-200 text-amber-800 text-[10px] font-bold">
                  ...
                  <button
                    ...
                    className="block text-[10px] font-bold text-brand-600 hover:text-brand-700 hover:underline w-full text-right"
                  >
                    Auto-balance essays →
                  </button>
                </div>
          ...
          <button
            ...
            className={clsx(
              ...
              canGenerate
                ? 'bg-gradient-to-r from-brand-600 via-indigo-600 to-semantic-ai text-white shadow-[0_6px_30px_rgba(99,102,241,0.35)] hover:shadow-[0_8px_40px_rgba(99,102,241,0.5)] hover:-translate-y-[1px] animate-glow cursor-pointer'
          ...
          >
            ...
            <Wand2 size={18} className={canGenerate ? 'text-indigo-200' : 'text-neutral-400'} />
            <span>Generate Pedagogical Question Paper</span>
            {canGenerate && <Sparkles size={14} className="text-indigo-200 animate-pulse" />}
          </button>
